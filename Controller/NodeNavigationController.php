...
App::uses('NodeNavigationAppController', 'NodeNavigation.Controller');

class NodeNavigationController extends NodeNavigationAppController {
 ...
 * @access public
 */
	public function admin_page_tree() {
		$this->set('title_for_layout', __('Page Tree'));
...
/**
 * Admin recover
 * Sometimes Croogo messes up a tree (need to find cause)
 * use this action to repair the page tree
 *
 * @return void
 * @access public
 */
